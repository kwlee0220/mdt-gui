...
# MDT GUI Front 서비스 설치 스크립트
# Ubuntu 22.04 systemd 서비스 생성

set -e
WORK_DIR=$MDT_HOME/mdt-gui/dtfront-main
BIN_HOME=$MDT_HOME/mdt-gui/sbin/dtfront

echo "MDT GUI Front 서비스를 설치합니다..."
...
echo "MDT GUI Front 서비스가 성공적으로 설치되고 시작되었습니다."
echo "서비스 관리 명령어:"

...
class ApiClient {
  constructor() {
     ...
     */
    this.basePath = "http://localhost:2746/".replace(/\/+$/, "");
    ...
    this.setVerifyingSsl(false);
  }

  setVerifyingSsl(isAuth) {
    // self-signed 인증서 허용을 위한 설정 추가
    if (isAuth) {
      this.requestAgent = null;
    } else {
      const https = require("https");
      this.requestAgent = new https.Agent({
